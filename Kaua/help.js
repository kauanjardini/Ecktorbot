const help = (prefix, pushname) => {
        return `
¥ Olá ${pushname} bem vindo ao menu do ECKTOR BOT

         ●ᎷᎬΝႮ●

¥「*VERSÃO: BOT 2.0 PRIVADO*」
...
------------ INFORMAÇÕES ------------
 ...
 ¥「*DONO: €KAUAN (base causs e dark)*」

 ¥「*CONTATO DO MEU DONO: wa.me/5544991150998*」
...
┌--------- MENU ----------
 ...
 ¥ *${prefix}figu*
 ¥ *${prefix}toimg*
 ¥ *${prefix}assttp*(faz figurinha animada)
...
NOTA »Mandar a msg sem o prefixo
 ...
 *NOME: Kauan*
 *INSTA: kauan_jardini*
 *WPP: wa.me/5544991150998*


----------- Ecktor BOT VIDAH ---------
¥  ║▌│█║▌│ █║▌│█│║▌║
¥  ║▌│█║▌│ █║▌│█│║▌║
Comporation by kauan`
}
exports.help = help
