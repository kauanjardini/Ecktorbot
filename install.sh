...
echo -e " ${RED}        __ __                          _                ___       _
echo -e " ${RED}       / //_/___ ___  ______ _____    (_)___ __________/ (_)___  (_)
echo -e " ${RED}      / ,< / __ `/ / / / __ `/ __ \  / / __ `/ ___/ __  / / __ \/ /
echo -e " ${RED}     / /| / /_/ / /_/ / /_/ / / / / / / /_/ / /  / /_/ / / / / / /
echo -e " ${RED}    /_/ |_\__,_/\__,_/\__,_/_/ /_/_/ /\__,_/_/   \__,_/_/_/ /_/_/
echo -e " ${RED}                             /___/
sleep 2
...
echo -e " ${YELLOW} modificado por Kauan. Base original de Causs que era do Dark que era do Mhakbarbar"
